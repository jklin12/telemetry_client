...
<div class="panel panel-inverse">
    <div class="panel-body">
        ...
        <form action="{{ route('mapjson.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-9">
                    ...
                    <input type="password" name="{{ $kf }}" id="input_{{ $kf }}" class="form-control m-b-5" placeholder="Masukan {{ $vf['label'] }}" value="{{ isset($data[$kf]) ? $data[$kf] : '' }}">
