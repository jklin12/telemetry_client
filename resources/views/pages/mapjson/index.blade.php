        ...
        <form action="" method="get">
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <a href="{{ route('mapjson.create')}}" class="btn btn-search btn-indigo"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
            ...
            <table class="table" id="station-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>  <a href="{{$value[$kf]}} " class="btn btn-yellow btn-icon btn-circle btn-md"><i class="fa fa-download"></i></a></td>
                        ...
                        <td>
                            <a href="{{ route('mapjson.edit', $value['id'])  }}" class="btn btn-indigo btn-icon btn-circle btn-md"><i class="fa fa-edit"></i></a>
                        </td>
                        <td>
                            <form action="{{ route('mapjson.destroy', $value['id']) }}" method="POST">
                                @csrf
                                @method('DELETE')
