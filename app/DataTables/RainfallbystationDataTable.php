...
use App\Models\Rainfallbystation;
...
class RainfallbystationDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Rainfallbystation $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(RainfallModel $model): QueryBuilder
    {
        return $model
            ->leftJoin('sch_data_station', 'sch_data_rainfall.station', '=', 'sch_data_station.station_id')
            ->orderBy(DB::raw('sch_data_station.station_id'))->newQuery();
    }
    ...
    {
        return $this->builder()
            ->setTableId('rainfallbystation-table')
    ...
    {
        return 'Rainfallbystation_' . date('YmdHis');
    }
